...
@app.get("/inquiry")
def get_inquiry(inquiry_id: int =None, password: str =None, db: SessionLocal = Depends(get_db)):
    if inquiry_id is None and password is None:
